 ...
 */
@Composable
fun NavController.OutlinedButtonPage() {
    ...
    Scaffold(topBar = {
        TopBarView(true, "OutlinedButton", this@OutlinedButtonPage, true)
    }, content = {
        Column(
            Modifier
                .padding(it)
            ...
            OutlinedButton(onClick = { /* Do something! */ }) { Text("Elevated Button") }
        }
    })
}