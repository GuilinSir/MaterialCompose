 ...
 * @date :   2023/7/12 1:46 PM
 */
object NavRoute {
    const val MAIN_PAGE = "main_page"

    const val BADGE_PAGE = "badge_page"
    const val BADGED_BOX_PAGE = "badged_box_page"

    const val BOTTOM_APP_BAR_PAGE = "bottom_app_bar_page"

    const val BOTTOM_SHEET_SCAFFOLD_PAGE = "bottom_sheet_scaffold_page"
